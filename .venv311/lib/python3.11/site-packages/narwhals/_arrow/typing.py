...
if TYPE_CHECKING:
    ...
    from pyarrow._stubs_typing import Indices  # noqa: F401
    from pyarrow._stubs_typing import Mask  # noqa: F401
    from pyarrow._stubs_typing import (  # pyright: ignore[reportMissingModuleSource]  # pyright: ignore[reportMissingModuleSource]  # pyright: ignore[reportMissingModuleSource]; noqa: F401
        Order,
    )
