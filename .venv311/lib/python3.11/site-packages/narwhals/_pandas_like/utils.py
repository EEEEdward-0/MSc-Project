...
def native_to_narwhals_dtype(
    ...
    if str_dtype.startswith(("large_list", "list", "struct", "fixed_size_list")):
        from narwhals._arrow.utils import native_to_narwhals_dtype as arrow_native_to_narwhals_dtype
    ...
    def is_dtype_numpy_nullable(dtype: Any) -> TypeIs[BaseMaskedDtype]:
        ...
        if isinstance(dtype, pd.api.extensions.ExtensionDtype):
            from pandas.core.arrays.masked import (
                BaseMaskedDtype as OldBaseMaskedDtype,  # type: ignore[attr-defined]; pyright: ignore[reportAttributeAccessIssue]
            )
