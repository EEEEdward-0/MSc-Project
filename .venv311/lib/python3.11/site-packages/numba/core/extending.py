...
from numba.core import config, errors, types, utils
...
from numba.core.pythonapi import NativeValue, box, reflect, unbox  # noqa: F401
...
def overload(func, jit_options={}, strict=True, inline='never',
    ...
    **kwargs prescribes additional arguments passed through to the overload
    ...
    """
    from numba.core.typing.templates import infer_global, make_overload_template
...
class _Intrinsic(ReduceMixin):
    ...
    def _register(self):
        # _ctor_kwargs
        from numba.core.typing.templates import infer_global, make_intrinsic_template
