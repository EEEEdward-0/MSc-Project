...
from numba.core import errors, sigutils, types, typing
from numba.core.extending import NativeValue, models, overload, register_model, typeof_impl, unbox
...
class TestPickling(TestCase):
    ...
    def test_external_function_pointers(self):
        ...
        from numba.tests.ctypes_usecases import c_cos, c_sin
