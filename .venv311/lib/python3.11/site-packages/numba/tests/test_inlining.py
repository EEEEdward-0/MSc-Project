...
from numba.core import compiler, ir, postproc, types
from numba.core.compiler_machinery import FunctionPass, PassManager, register_pass
from numba.core.inline_closurecall import inline_closure_call
from numba.core.ir_utils import find_callname, find_const, get_definition, guard, simplify_CFG
...
from numba.tests.support import TestCase, captured_stdout, override_config, skip_parfors_unsupported
...
class TestInlining(TestCase):
    ...
    def test_inner_function(self):
        from numba.tests.inlining_usecases import __name__ as prefix
