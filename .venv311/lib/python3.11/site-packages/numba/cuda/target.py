...
from numba.core import cgutils, config, datamodel, debuginfo, itanium_mangler, types, typing, utils
...
class CUDATargetContext(BaseContext):
    ...
    def load_additional_registries(self):
        ...
        from . import cudaimpl, libdeviceimpl, mathimpl, printimpl, vector_types
