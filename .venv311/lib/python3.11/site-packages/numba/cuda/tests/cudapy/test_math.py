...
import numpy as np
from numba import cuda, float32, float64, int32, int64, vectorize, void
from numba.cuda.testing import CUDATestCase, skip_on_cudasim, skip_unless_cc_53, unittest
