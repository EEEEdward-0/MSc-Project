...
from numba.core import cgutils, errors, serialize, sigutils, types
...
from numba.np.ufunc import _internal, ufuncbuilder
...
class UfuncAtIterator:
    ...
    def _prepare(self, context, builder):
        from numba.np.arrayobj import FancyIndexer, normalize_indices
